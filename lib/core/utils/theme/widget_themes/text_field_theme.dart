...
class CustomTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle()
        ...
        .copyWith(fontSize: CustomSizes.fontSizeMd, color: AppColors.black),


    hintStyle: const TextStyle()

        .copyWith(fontSize: CustomSizes.fontSizeSm, color: AppColors.black),
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle()
        ...
        .copyWith(fontSize: CustomSizes.fontSizeMd, color: AppColors.white),


    hintStyle: const TextStyle()

        .copyWith(fontSize: CustomSizes.fontSizeSm, color: AppColors.white),
